...
❗ Problem Statement: College students often want to hang out with friends but struggle to find affordable places within their limited budget.
...
💡 Solution: Smart Hangout Finder provides a simple and intelligent platform where students can discover hangout places based on their budget and preferred category.

The platform allows users to: ✔ Search hangout spots within their budget ✔ Filter places by category (Cafe, Restaurant, Mall, etc.) ✔ Get recommendations through an AI assistant ✔ Discover student-friendly places nearby
...
Example queries users can ask: Cafe under 300 Restaurant under 500 Best malls near Goregaon ⭐ Key Features 💰 Budget-Based Hangout Search
...
Cafe under ₹300 Restaurant under ₹500 Best malls near Andheri 📍 Mumbai-Based Recommendations
